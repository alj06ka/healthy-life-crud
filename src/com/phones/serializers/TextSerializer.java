...
public class TextSerializer implements Serializable {
    ...
    private void writeObject(Object object, OutputStreamWriter outputStreamWriter) throws IOException {
        ...
        if (object == null) {
            ...
            FieldOptions.FieldType fieldType = FieldsParser.getFieldType(object.getClass());
            String header = fieldType.toString() + ":" + className + ":";
            switch (fieldType) {
                case TEXT:
                    appendFormat(outputStreamWriter, header + "\"" + object.toString() + "\"");
                    break;
                case LIST:
                ...
                case OBJECT:
                    ...
                    appendFormat(outputStreamWriter, "[");
                    nestingLevel++;
                    ArrayList<FieldOptions> fields = FieldsParser.parseFields(object);
    ...
    private Object readObject(String inputString) throws InstantiationException, IllegalAccessException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException {
        ...
        FieldOptions.FieldType fieldType = FieldOptions.FieldType.valueOf(inputStringName);
        ...
        switch (fieldType) {
            case TEXT:
                ...
                if (objectClass != String.class) {
                    Method valueOf = objectClass.getMethod("valueOf", String.class);
    ...
    private static Object constructObject(String className, Map<String, Object> fields) throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        ...
        for (Map.Entry<String, Object> entry : fields.entrySet()){
            ...
            try {
                ...
                if (FieldsParser.isBoxed(fieldType)) {
                    setterMethod = classDefinition.getMethod(setterName, FieldsParser.getBoxedType(fieldType));
                } else {
                    throw e;
                }
            }
